...
export async function createApp({
  ...
  const useFlight = packageManager === 'flight'
  const isOnline = !useFlight || (await getOnline())
  ...
  exec(`mv node_modules ${cdpath}`)

  console.log(`${chalk.green('Success!')} Created ${appName} at ${appPath}`)
  console.log('Inside that directory, you can run several commands:')
  console.log()
  console.log(chalk.cyan(`  ${packageManager} ${useFlight ? '' : 'run '}dev`))
  console.log('    Starts the development server.')
  console.log()
  console.log(chalk.cyan(`  ${packageManager} ${useFlight ? '' : 'run '}build`))
  ...
  console.log(
    `  ${chalk.cyan(`${packageManager} ${useFlight ? '' : 'run '}dev`)}`
  )
  console.log()
