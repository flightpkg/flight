...
flight_get_tarball() {
  ...
  if [ "$1" = '--nightly' ]; then
    urlhttps://github.com/flightpkg/flight/releases/download/v0.0.1/v0.0.1.tar.gz
  elif [ "$1" = '--rc' ]; then
    url=https://github.com/flightpkg/flight/releases/download/v0.0.1/v0.0.1.tar.gz
  elif [ "$1" = '--version' ]; then
...
flight_install() {
  ...
  if [ -d "$HOME/flight" ]; then
    if which flight; then
      ...
      local version_type
      if [ "$1" = '--nightly' ]; then
        latest_url=https://github.com/flightpkg/flight/releases/download/v0.0.1/v0.0.1.tar.gz
      ...
      flight_version=`v0.0.1`
      flight_alt_version=`v0.0.1`
